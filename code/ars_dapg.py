...
class Worker(object):
    ...
    def __init__(self, env_seed,
        ...
        if task_id == 'relocate':
            self.env = GymEnv('relocate-v0', "Torque", policy_params['object'])
        else:
...
class ARSLearner(object):
    ...
    def __init__(self, task_id='relocate',
        ...
        if task_id == 'relocate':
            ...
            env = GymEnv('relocate-v0', "Torque", policy_params['object'])
        else:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--delta_std', '-std', type=float, default=0.1)# 0.03, v in the paper
